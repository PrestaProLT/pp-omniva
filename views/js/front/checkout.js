...
(function () {
    ...
    function renderTerminalList(container, terminals) {
        ...
        if (!terminals.length) {
            listEl.innerHTML = '<div class="ppomniva-pickup__empty">No terminals found.</div>';
            return;
        }
        ...
        terminals.forEach(function (t) {
            ...
            var codBadge = (parseInt(t.cod_enabled, 10) === 1)
                ? '<span class="ppomniva-pickup__item-cod ppomniva-pickup__item-cod--yes" title="Cash on Delivery available">€</span>'
                : '<span class="ppomniva-pickup__item-cod ppomniva-pickup__item-cod--no" title="No Cash on Delivery">€</span>';
    ...
    function showLoading(container) {
        var listEl = container.querySelector('.ppomniva-pickup__list-items');
        if (listEl) {
            listEl.innerHTML = '<div class="ppomniva-pickup__loading">Loading terminals...</div>';
        }
    }
