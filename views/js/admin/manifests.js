...
(function () {
    ...
    var modal = document.getElementById('ppo-courier-modal');
    var manifestLabel = document.getElementById('ppo-courier-manifest');
    var dateInput = document.getElementById('ppo-courier-date');
    var fromSelect = document.getElementById('ppo-courier-from');
    var toSelect = document.getElementById('ppo-courier-to');
    var commentInput = document.getElementById('ppo-courier-comment');
    var noticeContainer = document.getElementById('ppo-manifests-notice');
    ...
    function openCourierModal(manifestId) {
        ...
        document.body.classList.add('ppo-modal-open');
    }

    function hideCourierModal() {
        if (!modal) return;
        modal.style.display = 'none';
        document.body.classList.remove('ppo-modal-open');
        activeManifestId = '';
    }
    ...
    function setLoading(btn, loading) {
        if (window.PPOmnivaAdmin && window.PPOmnivaAdmin.setLoading) {
            window.PPOmnivaAdmin.setLoading(btn, loading);
        } else {
    ...
    function notice(type, message) {
        if (window.PPOmnivaAdmin && window.PPOmnivaAdmin.showNotice) {
            window.PPOmnivaAdmin.showNotice(noticeContainer || document.body, type, message);
        }
