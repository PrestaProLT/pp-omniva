    ...
    public function index(Request $request): Response
    {
        ...
        $rows = $db->executeS(
            'SELECT v.*, o.reference AS ps_reference, o.total_paid_tax_incl AS ps_total,
             ...
             ' . $sqlBase . '
             ORDER BY v.id_ppomniva_order DESC
        ...
        return $this->render('@Modules/ppomniva/views/templates/admin/orders.html.twig', [
            'orders' => $rows,
            'total' => $total,
            'page' => $page,
            ...
            'index_url' => $this->generateUrl('ps_ppomniva_orders'),
            'multistore_blocked' => false,
            'pickup_ref' => (int) Configuration::get('PPOMNIVA_PICKUP_ID_REF'),
            'courier_ref' => (int) Configuration::get('PPOMNIVA_COURIER_ID_REF'),
        ]);
    }
