...
class TerminalController extends FrameworkBundleAdminController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->render('@Modules/ppomniva/views/templates/admin/terminals.html.twig', [
    ...
    public function sync(Request $request): RedirectResponse
    {
        ...
        if ($country === 'ALL') {
            ...
            $this->addFlash('error', $this->trans('Invalid country code.', 'Modules.Ppomniva.Admin'));

            return $this->redirectToRoute('ps_ppomniva_terminals');
        }
        ...
        return $this->redirectToRoute('ps_ppomniva_terminals', $country !== 'ALL' ? ['country' => $country] : []);
    }
