...
{
    private const CONFIG_KEY = 'PPOMNIVA_COD_MODULES';
    ...
    public function index(): Response
    {
        ...
        return $this->render('@Modules/ppomniva/views/templates/admin/cod.html.twig', [
            'available_modules' => $available,
            'selected' => $selected,
            'orphans' => $orphans,
            'save_url' => $this->generateUrl('ps_ppomniva_cod_save'),
    ...
    public function save(Request $request): RedirectResponse
    {
        ...
        return $this->redirectToRoute('ps_ppomniva_cod');
    }
